...
def RGB(number: list[int, int, int] = None) -> None or dict[str, list[int, int, int] or int or str]:
...
def hexadecimal(number: str = None) -> None or dict[str, list[int, int, int] or int or str]:
...
def decimal(number: int = None) -> None or dict[str, list[int, int, int] or int or str]:
